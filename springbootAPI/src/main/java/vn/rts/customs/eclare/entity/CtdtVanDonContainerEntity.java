...
@Entity
@Table(name = EntityTableEtcCustomsEClare.CTDT_VAN_DON_CONTAINER)
@JsonAutoDetect(fieldVisibility = Visibility.ANY)
@NoArgsConstructor
@Data
@EqualsAndHashCode(callSuper = true)
public class CtdtVanDonContainerEntity extends ConditionalBaseEoEx<CtdtVanDonContainerEntity, Long> implements Serializable {
	private static final long serialVersionUID = 1L;

	@ApiModelProperty(notes = "ID")
	@Id
	@SequenceGenerator(name = "SequenceIdGenerator", sequenceName = "seq_CTDT_VAN_DON_CONTAINER", allocationSize = 1)
	...
	@Basic
	@Column(name = "CTDT_VAN_DON_ID", nullable = false, columnDefinition = "NUMBER")
	...
	@Override
	public CtdtVanDonContainerEntity cloneNotRef() {
