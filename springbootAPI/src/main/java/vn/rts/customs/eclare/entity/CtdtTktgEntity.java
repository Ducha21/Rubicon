...
@Entity
@Table(name = ConstantEtcCustomsEClare.EntityTableEtcCustomsEClare.CTDT_TKTG)
@JsonAutoDetect(fieldVisibility = Visibility.ANY)
@NoArgsConstructor
@Data
@EqualsAndHashCode(callSuper = true)
public class CtdtTktgEntity extends ConditionalBaseEoEx<CtdtTktgEntity, Long> implements Serializable {
	private static final long serialVersionUID = 1L;
	  
    @ApiModelProperty(notes = "ID")
    @Id
    @SequenceGenerator(name = "SequenceIdGenerator", sequenceName = "SEQ_CTDT_TKTG", allocationSize = 1)
	...
	@Override
	public CtdtTktgEntity cloneNotRef() {
