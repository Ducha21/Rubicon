...
@Entity
@Table(name = ConstantEtcCustomsEClare.EntityTableEtcCustomsEClare.CTDT_CTAT_5_PHAN_TRAM)
@JsonAutoDetect(fieldVisibility = Visibility.ANY)
@NoArgsConstructor
@Data
@EqualsAndHashCode(callSuper = true)
public class CtdtCtat5PhanTramEntity extends ConditionalBaseEoEx<CtdtCtat5PhanTramEntity, Long> implements Serializable {
	private static final long serialVersionUID = 1L;
	  
    @ApiModelProperty(notes = "ID")
    @Id
    @SequenceGenerator(name = "SequenceIdGenerator", sequenceName = "SEQ_CTDT_CTAT_5_PHAN_TRAM", allocationSize = 1)
	...
	@Override
	public CtdtCtat5PhanTramEntity cloneNotRef() {
